          ...
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Suhu Tertinggi</h6>
      ...
      <div class="col-md-4">
        <px-card class="static-top-widget-card">
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Suhu Terendah</h6>
      ...
      <div class="col-md-4">
        <px-card class="static-top-widget-card">
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Suhu Rata-rata</h6>
      ...
      <div class="col-md-4">
        <px-card class="static-top-widget-card">
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Saturasi Oksigen Tertinggi</h6>
      ...
      <div class="col-md-4">
        <px-card class="static-top-widget-card">
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Saturasi Oksigen Terendah</h6>
                <h4 class="mb-0 counter">45631</h4>
              </div>
              <svg
                class="fill-danger"
      ...
      <div class="col-md-4">
        <px-card class="static-top-widget-card">
          <div slot="with-padding">
            <div class="media static-top-widget">
              <div class="media-body">
                <h6 class="font-roboto">Saturasi Oksigen Rata-rata</h6>
                <h4 class="mb-0 counter">45631</h4>
              </div>
              <svg
                class="fill-danger"
